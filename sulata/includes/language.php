...
define('SEARCH_NOT_FOUND', 'Sorry, your search returned no results.');
...
define('API_ERROR', 'Sorry, there has been an error processing the request:');
define('API_SUCCESS', 'Request processed successfully.');

                                ...
                                <form class="form-horizontal" name="searchForm" id="searchForm" method="get" action="">
                                    <fieldset id="search-area1">
                                        ...
                                        <div class="lineSpacer clear"></div>
                                         <div class="pull-right"><a style="text-decoration:underline !important;" href="<?php echo ADMIN_URL;?>menus-cards/">Clear search.</a></div>
                                        </div>
                                        <?php } ?>
                                    </fieldset>
                                </form>
...
?>
                                        ...
                                        <div class="col-xs-12 col-sm-4 col-md-4 col-lg-4" id="card_<?php echo $row['menu__ID']; ?>">
                                            ...
                                            <?php if (($editAccess == TRUE) || ($deleteAccess == TRUE)) { ?>
                                                    ...
                                                    <header>
                                                        <a href="<?php echo ADMIN_URL; ?>menu-details/<?php echo $row['menu__ID']; ?>/"><i class="fa fa-dollar"> Update Menu Price</i></a> - 
                                                        <?php if ($editAccess == TRUE) { ?>

                                                            <a href="<?php echo ADMIN_URL; ?>menus-update/<?php echo $row['menu__ID']; ?>/"><i class="fa fa-edit"></i></a> - 
                                                        <?php } ?>

                                                        <?php if ($deleteAccess == TRUE) { ?>

                                                            <a onclick="return delById('card_<?php echo $row['menu__ID']; ?>', '<?php echo CONFIRM_DELETE; ?>')" href="<?php echo ADMIN_URL; ?>menus-remote/delete/<?php echo $row['menu__ID']; ?>/" target="remote"><i class="fa fa-trash"></i></a>
                                                        <?php } ?>

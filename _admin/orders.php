...
checkLogin();
$pageName='Manage Orders';$pageTitle='Manage Orders';

//Make select statement. The $SqlFrom is also used in $sqlP below.    
$sqlSelect = "SELECT order__ID,order__Number,order__Customer_Name,order__Mobile_Number ";
                                ...
                                <form class="form-horizontal" name="searchForm" id="searchForm" method="get" action="">
                                    <fieldset id="search-area1">
                                        ...
                                        <div class="lineSpacer clear"></div>
                                         <div class="pull-right"><a style="text-decoration:underline !important;" href="<?php echo ADMIN_URL;?>orders/">Clear search.</a></div>
                                        </div>
                                        <?php } ?>
                                    </fieldset>
                                </form>
...
<td><?php echo suUnstrip($row['order__Mobile_Number']);?></td>
    ...
    <?php if ($editAccess == TRUE) { ?>
                                                <a href="<?php echo ADMIN_URL;?>orders-update/<?php echo $row['order__ID'];?>/"><img border="0" src="<?php echo BASE_URL; ?>sulata/images/edit.png" title="<?php echo EDIT_RECORD; ?>"/></a>
                                                    <?php } ?>
<?php if ($deleteAccess == TRUE) { ?>
                                                <a onclick="return delRecord(this, '<?php echo CONFIRM_DELETE; ?>')" href="<?php echo ADMIN_URL; ?>orders-remote/delete/<?php echo $row['order__ID']; ?>/" target="remote"><img border="0" src="<?php echo BASE_URL; ?>sulata/images/delete.png" title="<?php echo DELETE_RECORD; ?>"/></a>
                                                    <?php } ?>
                                            </td>
                                            <?php } ?>

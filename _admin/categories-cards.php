                                ...
                                <form class="form-horizontal" name="searchForm" id="searchForm" method="get" action="">
                                    <fieldset id="search-area1">
                                        ...
                                        <?php if ($_GET['q']) { ?>
                                            ...
                                            <div class="pull-right"><a style="text-decoration:underline !important;" href="<?php echo ADMIN_URL; ?>categories-cards/">Clear search.</a></div>
                                            </div>
                                        <?php } ?>
                                    </fieldset>
                                </form>
...
//Get records from database
                                ...
                                while ($row = suFetch($result)) {
                                    ?>
                                    <!-- CARDS START -->
                                    <div class="col-xs-12 col-sm-4 col-md-4 col-lg-4" id="card_<?php echo $row['category__ID']; ?>">
                                        <div class="card">
                                            ...
                                            <h1>
                                                <?php
                                                if (!isset($row['category__Category']) || ($row['category__Category'] == '')) {
                                                    echo "-";
                                                } else {
                                                    echo suSubstr(suUnstrip($row['category__Category']));
                                                }
                                                ?>
                                            </h1>
                                            <?php if (($editAccess == TRUE) || ($deleteAccess == TRUE)) { ?>

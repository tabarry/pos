                                ...
                                while ($row = suFetch($result)) {
                                    ...
                                    <div class="col-xs-12 col-sm-4 col-md-4 col-lg-4" id="card_<?php echo $row['product__ID']; ?>">
                                        <div class="card">
                                            ...
                                            <p>
                                                <?php
                                                if (!isset($row['product__Category']) || ($row['product__Category'] == '')) {
                                                    echo "-";
                                                } else {
                                                    echo suSubstr(suUnstrip($row['product__Category']));
                                                }
                                                ?>
                                            </p>
                                            <label>Picture</label>
                                            ...
                                            ?>
                                            <div class="imgThumb" style="background-image:url(<?php echo $defaultImage; ?>);"></div><label>Code</label>
                                            ...
                                            <p>
                                                ...
                                                if (!isset($row['product__Code']) || ($row['product__Code'] == '')) {
                                                    ...
                                                    echo suSubstr(suUnstrip($row['product__Code']));
                                                }
                                                ?>
                                            </p>
                                            <label>Name</label>
                                            ...
                                            <h1>
                                                ...
                                                if (!isset($row['product__Name']) || ($row['product__Name'] == '')) {
                                                    ...
                                                    echo suSubstr(suUnstrip($row['product__Name']));
                                                }
                                                ?>
                                            </h1>
                                            <label>Price</label>
                                            ...
                                            <p>
                                                <?php
                                                if (!isset($row['product__Price']) || ($row['product__Price'] == '')) {
                                                    echo "-";
                                                } else {
                                                    echo $getSettings['site_currency'] . ' ' . suSubstr(number_format($row['product__Price'], 2));
                                                }
                                                ?>
                                            </p>
                                            <label>Status</label>

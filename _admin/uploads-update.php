...
$pageName='Update Uploads';$pageTitle='Update Uploads';
?>
<!DOCTYPE html>
<html>
    <head>
    ...
    <body>
        ...
        <form class="form-horizontal" action="<?php echo ADMIN_SUBMIT_URL; ?>uploads-remote/update/" accept-charset="utf-8" name="suForm" id="suForm" method="post" target="remote" enctype="multipart/form-data">

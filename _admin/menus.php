...
checkLogin();
$pageName='Manage Menus';$pageTitle='Manage Menus';
        ...
        <div class="outer">
            ...
            <div class="mainbar">
                ...
                <div class="main-content">
                                ...
                                <form class="form-horizontal" name="searchForm" id="searchForm" method="get" action="">
                                    <fieldset id="search-area1">
                                        ...
                                        <div class="lineSpacer clear"></div>
                                         <div class="pull-right"><a style="text-decoration:underline !important;" href="<?php echo ADMIN_URL;?>menus/">Clear search.</a></div>
                                        </div>
                                        <?php } ?>
                                    </fieldset>
                                </form>
                    ...
                    <div id="table-area"><a href="<?php echo ADMIN_URL;?>menus-add/" class="btn btn-black">Add new..</a></div>
                        <?php } ?>
                        <?php
                                    $fieldsArray = array('menu__Title','menu__Status');
                                    suSort($fieldsArray);
...
?>
                                        <tr>
                                            ...
                                            <td><?php echo suUnstrip($row['menu__Title']);?></td>
<td><?php echo suUnstrip($row['menu__Status']);?></td>

    <?php if (($editAccess == TRUE) || ($deleteAccess == TRUE)) { ?>
    <td style="text-align: center;">
    <?php if ($editAccess == TRUE) { ?>
                                                <a href="<?php echo ADMIN_URL;?>menus-update/<?php echo $row['menu__ID'];?>/"><img border="0" src="<?php echo BASE_URL; ?>sulata/images/edit.png" title="<?php echo EDIT_RECORD; ?>"/></a>
                                                    <?php } ?>
<?php if ($deleteAccess == TRUE) { ?>
                                                <a onclick="return delRecord(this, '<?php echo CONFIRM_DELETE; ?>')" href="<?php echo ADMIN_URL; ?>menus-remote/delete/<?php echo $row['menu__ID']; ?>/" target="remote"><img border="0" src="<?php echo BASE_URL; ?>sulata/images/delete.png" title="<?php echo DELETE_RECORD; ?>"/></a>
                                                    <?php } ?>
                                            </td>
                                            <?php } ?>
...
<!-- /TABLE -->
                    <?php
                                ...
                                <?php if ($downloadAccessCSV == TRUE && $numRows > 0) { ?>
                                    <p>&nbsp;</p>
                                    <p><a target="remote" href="<?php echo ADMIN_URL; ?>menus/stream-csv/" class="btn btn-black pull-right"><i class="fa fa-download"></i> Download CSV</a></p>
                                    <p>&nbsp;</p>
                                    <div class="clearfix"></div>
                                <?php } ?>
                                <?php if ($downloadAccessPDF == TRUE && $numRows > 0) { ?>
                                    <p>&nbsp;</p>
                                    <p><a target="remote" href="<?php echo ADMIN_URL; ?>menus/stream-pdf/" class="btn btn-black pull-right"><i class="fa fa-download"></i> Download PDF</a></p>
                                    <p>&nbsp;</p>
                                    <div class="clearfix"></div>
                                <?php } ?>

...
$pageName='Update Orders';$pageTitle='Update Orders';
?>
<!DOCTYPE html>
<html>
    <head>
    ...
    <body>
        ...
        <form class="form-horizontal" action="<?php echo ADMIN_SUBMIT_URL; ?>orders-remote/update/" accept-charset="utf-8" name="suForm" id="suForm" method="post" target="remote" >

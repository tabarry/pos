...
$sql = "SELECT product__ID,product__Category,product__Picture,product__Code,product__Name,product__Price,product__Cost_Price,product__Description,product__Status FROM sulata_products WHERE product__dbState='Live' AND product__ID='" . $id . "'";
$result = suQuery($sql);
                                    ...
                                    <div class="gallery clearfix">
                                        <div class="form-group">
                                            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">        
                                                ...
                                                echo suDropdown('product__Category', $options, suUnstrip($row['product__Category']), $js)
                                                ?>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">  
                                                ...
                                                <?php
                                                $arg = array('type' => $dbs_sulata_products['product__Picture_html5_type'], 'name' => 'product__Picture', 'id' => 'product__Picture');
                                        ...
                                        <?php if ((file_exists(ADMIN_UPLOAD_PATH . $row['product__Picture'])) && ($row['product__Picture'] != '')) { ?>
                                            <a class="underline" href="<?php echo BASE_URL . 'files/' . $row['product__Picture']; ?>" target="_blank"><?php echo VIEW_FILE; ?></a>
                                        <?php } ?>    
                                        ...
                                        <?php
                                        $arg = array('type' => 'hidden', 'name' => 'previous_product__Picture', 'id' => 'previous_product__Picture', 'value' => $row['product__Picture']);
                                        echo suInput('input', $arg);
                                        ?>   
                                        ...
                                        <div class="form-group">
                                            <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6">                
                                                ...
                                                <?php
                                                $arg = array('type' => $dbs_sulata_products['product__Code_html5_type'], 'name' => 'product__Code', 'id' => 'product__Code', 'autocomplete' => 'off', 'maxlength' => $dbs_sulata_products['product__Code_max'], 'value' => suUnstrip($row['product__Code']), $dbs_sulata_products['product__Code_html5_req'] => $dbs_sulata_products['product__Code_html5_req'], 'class' => 'form-control');
                                                echo suInput('input', $arg);
                                                ?>
                                            </div>
                                            ...
                                            <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6">                
                                                ...
                                                <?php
                                                $arg = array('type' => $dbs_sulata_products['product__Name_html5_type'], 'name' => 'product__Name', 'id' => 'product__Name', 'autocomplete' => 'off', 'maxlength' => $dbs_sulata_products['product__Name_max'], 'value' => suUnstrip($row['product__Name']), $dbs_sulata_products['product__Name_html5_req'] => $dbs_sulata_products['product__Name_html5_req'], 'class' => 'form-control');
                                                echo suInput('input', $arg);
                                                ?>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6">            
                                                ...
                                                <?php
                                                $arg = array('type' => $dbs_sulata_products['product__Cost_Price_html5_type'], 'name' => 'product__Cost_Price', 'id' => 'product__Cost_Price', 'autocomplete' => 'off', 'maxlength' => $dbs_sulata_products['product__Cost_Price_max'], 'value' => suUnstrip($row['product__Cost_Price']), $dbs_sulata_products['product__Cost_Price_html5_req'] => $dbs_sulata_products['product__Cost_Price_html5_req'], 'class' => 'form-control');
                                                echo suInput('input', $arg);
                                                ?>
                                            </div>    
                                            ...
                                            <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6">            
                                                ...
                                                <?php
                                                $arg = array('type' => $dbs_sulata_products['product__Price_html5_type'], 'name' => 'product__Price', 'id' => 'product__Price', 'autocomplete' => 'off', 'maxlength' => $dbs_sulata_products['product__Price_max'], 'value' => suUnstrip($row['product__Price']), $dbs_sulata_products['product__Price_html5_req'] => $dbs_sulata_products['product__Price_html5_req'], 'class' => 'form-control');
                                                echo suInput('input', $arg);
                                                ?>
                                            </div>    
                                        </div>
                                        ...
                                        <div class="form-group">
                                            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">                
                                                ...
                                                echo suInput('textarea', $arg, suUnstrip($row['product__Description']), TRUE);
                                                ?>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">        
                                                ...
                                                $js = "class='form-control'";
                                                echo suDropdown('product__Status', $options, suUnstrip($row['product__Status']), $js)
                                                ?>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                        ...
                                        echo suInput('input', $arg);
                                        //Id field
                                        $arg = array('type' => 'hidden', 'name' => 'product__ID', 'id' => 'product__ID', 'value' => $id);
                                        echo suInput('input', $arg);
                                        ?>
                                        <p>&nbsp;</p>
                                </form>

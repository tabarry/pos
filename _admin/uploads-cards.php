...
//Get records from database
                                ...
                                while ($row = suFetch($result)) {
                                    ?>
                                    <!-- CARDS START -->
                                    <div class="col-xs-12 col-sm-4 col-md-4 col-lg-4" id="card_<?php echo $row['upload__ID']; ?>">
                                        <div class="card">
                                            ...
                                            <h1>
                                                <?php
                                                if (!isset($row['upload__Title']) || ($row['upload__Title'] == '')) {
                                                    echo "-";
                                                } else {
                                                    echo suSubstr(suUnstrip($row['upload__Title']));
                                                }
                                                ?>
                                            </h1>
                                            <label>Picture</label>

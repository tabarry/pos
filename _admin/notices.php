...
checkLogin();
$pageName='Manage Notices';$pageTitle='Manage Notices';
        ...
        <div class="outer">
            ...
            <div class="mainbar">
                ...
                <div class="main-content">
                        ...
                        <div class="page-content">
                            ...
                            <div class="single-head">
                                ...
                                <div class="pull-right">
                                    <a href="<?php echo ADMIN_URL; ?>notices-cards/"><i class="fa fa-th-large"></i></a>
                                </div>
                                ...
                                <form class="form-horizontal" name="searchForm" id="searchForm" method="get" action="">
                                    <fieldset id="search-area1">
                                        ...
                                        <div class="lineSpacer clear"></div>
                                         <div class="pull-right"><a style="text-decoration:underline !important;" href="<?php echo ADMIN_URL;?>notices/">Clear search.</a></div>
                                        </div>
                                        <?php } ?>
                                    </fieldset>
                                </form>
                    ...
                    <div id="table-area"><a href="<?php echo ADMIN_URL;?>notices-add/" class="btn btn-black">Add new..</a></div>
                        <?php } ?>
                        <?php
                                    $fieldsArray = array('notice__Subject');
                                    suSort($fieldsArray);
...
?>
                                        <tr>
                                            ...
                                            <td><?php echo suUnstrip($row['notice__Subject']);?></td>

    <?php if (($editAccess == TRUE) || ($deleteAccess == TRUE)) { ?>
    <td style="text-align: center;">
    <?php if ($editAccess == TRUE) { ?>
                                                <a href="<?php echo ADMIN_URL;?>notices-update/<?php echo $row['notice__ID'];?>/"><img border="0" src="<?php echo BASE_URL; ?>sulata/images/edit.png" title="<?php echo EDIT_RECORD; ?>"/></a>
                                                    <?php } ?>
<?php if ($deleteAccess == TRUE) { ?>
                                                <a onclick="return delRecord(this, '<?php echo CONFIRM_DELETE; ?>')" href="<?php echo ADMIN_URL; ?>notices-remote/delete/<?php echo $row['notice__ID']; ?>/" target="remote"><img border="0" src="<?php echo BASE_URL; ?>sulata/images/delete.png" title="<?php echo DELETE_RECORD; ?>"/></a>
                                                    <?php } ?>
                                            </td>
                                            <?php } ?>
...
<!-- /TABLE -->
                    <?php
                                ...
                                <?php if ($downloadAccessCSV == TRUE && $numRows > 0) { ?>
                                    <p>&nbsp;</p>
                                    <p><a target="remote" href="<?php echo ADMIN_URL; ?>notices/stream-csv/" class="btn btn-black pull-right"><i class="fa fa-download"></i> Download CSV</a></p>
                                    <p>&nbsp;</p>
                                    <div class="clearfix"></div>
                                <?php } ?>
                                <?php if ($downloadAccessPDF == TRUE && $numRows > 0) { ?>
                                    <p>&nbsp;</p>
                                    <p><a target="remote" href="<?php echo ADMIN_URL; ?>notices/stream-pdf/" class="btn btn-black pull-right"><i class="fa fa-download"></i> Download PDF</a></p>
                                    <p>&nbsp;</p>
                                    <div class="clearfix"></div>
                                <?php } ?>

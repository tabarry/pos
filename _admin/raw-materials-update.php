...
$pageName = 'Update Raw Materials';
$pageTitle = 'Update Raw Materials';
?>
<!DOCTYPE html>
<html>
    <head>
                    ...
                    <div class="container">
                        ...
                        <div class="page-content">
                            ...
                            <div id="content-area">
                                ...
                                <form class="form-horizontal" action="<?php echo ADMIN_SUBMIT_URL; ?>raw-materials-remote.php/update/" accept-charset="utf-8" name="suForm" id="suForm" method="post" target="remote" >

...
$pageName = 'Update Open Orders';
$pageTitle = 'Update Open Orders';
?>
<!DOCTYPE html>
<html>
    <head>
                    ...
                    <div class="container">
                        ...
                        <div class="page-content">
                            ...
                            <div id="content-area">
                                ...
                                <form class="form-horizontal" action="<?php echo ADMIN_SUBMIT_URL; ?>open-orders-remote.php/update/" accept-charset="utf-8" name="suForm" id="suForm" method="post" target="remote" >

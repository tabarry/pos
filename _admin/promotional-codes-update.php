...
$pageName='Update Promotional Codes';$pageTitle='Update Promotional Codes';
?>
<!DOCTYPE html>
<html>
    <head>
    ...
    <body>
        ...
        <form class="form-horizontal" action="<?php echo ADMIN_SUBMIT_URL; ?>promotional-codes-remote/update/" accept-charset="utf-8" name="suForm" id="suForm" method="post" target="remote" >

...
checkLogin();
$pageName='Daily Sales Summary';$pageTitle='Daily Sales Summary';
$downloadAccess = TRUE;
                    ...
                    <div class="container">
                        ...
                        <div class="page-content">
                            ...
                            <div class="single-head">
                                ...
                                <div class="pull-right"><a style="text-decoration:underline !important;" href="<?php echo ADMIN_URL; ?>daily-sales-summary/">Clear search.</a></div>
                                    <?php }?>
                                    </div>
                                </form>
                                <div class="clearfix"></div>
